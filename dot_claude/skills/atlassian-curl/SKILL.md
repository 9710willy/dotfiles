...
export JIRA_BASE="https://example.atlassian.net/rest/api/3"
export CONFLUENCE_BASE="https://example.atlassian.net/wiki/api/v2"
export CONFLUENCE_V1_BASE="https://example.atlassian.net/wiki/rest/api"  # Required for CQL search (v2 has no search endpoint)
```
...
export CONFLUENCE_V1_BASE="${CONFLUENCE_V1_BASE:-https://example.atlassian.net/wiki/rest/api}"
export JIRA_BASE="${JIRA_BASE:-https://example.atlassian.net/rest/api/3}"
```
